from block_preprocess import process_plumber, blockify, write_blocks_to_file, write_page_to_block, get_block_content, write_each_block_to_file, write_chapter_to_block
import os
root = os.getcwd()
...
# write chapter mapping to file
write_chapter_to_block(book_name, chapters)
